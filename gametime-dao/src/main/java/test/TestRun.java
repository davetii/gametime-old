...
import com.gametime.data.common.Person;
...
public class TestRun implements CommandLineRunner{
    ...
    public void run(String... strings) throws Exception {
        ...
        jdbcTemplate.batchUpdate("INSERT INTO players(first_name, last_name) VALUES (?,?)", splitUpNames);

        log.info("Querying for customer records where first_name = 'Josh':");

        jdbcTemplate.query(
                "SELECT id, first_name, last_name FROM players WHERE first_name = ?", new Object[] { "Josh" },
